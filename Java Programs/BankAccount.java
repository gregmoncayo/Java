...
public class BankAccount
{
  ...
  {
     /*YOUR CODE HERE*/
      name = n;         // sets the name from the parameter
      balance = 0.00;   // sets balance to 0.00
  ...
  public BankAccount(String n, double b)   
  {
    /*YOUR CODE HERE*/
      ...
      // error checks if balance parameter is less than 0.00, sets to 0.00
  ...
  public void withdraw(double w)	
  {
	 ...
	 if (w <= balance && w >= 0.00)
     {
      ...
      {
          System.out.printf("Your account balance is only $%.2f %s", balance,"-- you cannot withdraw");
          System.out.print("\n");
      }
  ...
  public void printBal()
  {
	/*YOUR CODE HERE*/
      ...
      System.out.printf("%s%s%.2f", name, " Current balance : $ ", balance);
      System.out.println();
